...
<head runat="server">
    ...
    <style>
        :root { --auth-logo-inset: 80px; }

        html, body { height: 100%; margin: 0; }
        body { background: #fdfaf4; overflow: hidden; }
        ...
        .auth-header .brand { display: inline-flex; align-items: center; line-height: 0; }
        ...
        .split__art-copy { flex-shrink: 0; max-width: 440px; }
        .split__eyebrow {
            margin: 0 0 8px;
            font-size: 0.78rem;
            font-weight: 700;
        ...
        .split__links a { color: var(--accent, #b9703c); font-weight: 600; }

        @media (max-width: 860px) {
            body { overflow: auto; }
            .auth-main { grid-template-columns: 1fr; height: auto; min-height: calc(100vh - 66px); }
